...
<head>
    ...
    <title>Calzado y Accesorios - Fashion Style</title>
    <!-- Bootstrap -->
...
<body>
    <div class="main-container">
        ...
        <main class="content">
            ...
            <section class="hero">
                <div class="hero-text">
                    <h1>CALZADO Y ACCESORIOS</h1>
                    <p>Encuentra el calzado perfecto para completar tu estilo.</p>
                </div>
                <div class="products">
                    @forelse ($calzado as $producto)
                        <div class="product shadow-sm border p-3 rounded-4 bg-white mb-4 d-inline-block text-center" style="width: 250px; margin: 10px; transition: transform 0.3s; position: relative;">
                            <img src="{{ $producto['images'][0] ?? ''}}" alt="{{ $producto['title'] ?? 'Calzado' }}" class="img-fluid rounded-4 mb-3" style="height: 150px; object-fit: contain;">
                    ...
                    @empty
                        <p>No hay calzado disponible en este momento.</p>
                    @endforelse
                </div>
            </section>
        </main>
